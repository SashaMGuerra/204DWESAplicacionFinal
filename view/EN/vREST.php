...
<main>
    ...
    <div class="container">
        <div class="mainH1">
            <h1>Rest</h1>
            <div>
                <button form="layoutForm" name="volver" value="volver">Go Back</button>
            </div>
        </div>
        <form id="menuRESTForm" method="post">
            <nav>
                <ul>
                    <li><button type="submit" name="RESTEnCurso" value="diccionario">Dictionary</button></li>
                    <li><button type="submit" name="RESTEnCurso" value="conversor">Converter</button></li>
                    <li><button type="submit" name="RESTEnCurso" value="buscarDPTOpropio">Search DPMT (own)</button></li>
                    <li><button type="submit" name="RESTEnCurso" value="buscarDPTOajeno">Search DPMT (Óscar)</button></li>
                </ul>
            </nav>
        </form>
        <section id="diccionario">
            <div class="diccionario">
                <h2>Google dictionary<sup><a href="https://dictionaryapi.dev/" target="_blank">ⓘ</a></sup></h2>
                <div class="restDescripcion">Google dictionary web service. Works in English and Spanish. Returns the word's meanings, sometimes with its word type and origin.</div>
                <form method="post" id="restForm">
                    <fieldset>
                        <input type="text" name="word" placeholder="Word to search">
                        <select name="language">
                            <option value="EN" <?php echo $aVRESTDiccionario['language'] == 'EN' ? 'selected' : '' ?>>English</option>
                            <option value="ES" <?php echo $aVRESTDiccionario['language'] == 'ES' ? 'selected' : '' ?>>Spanish</option>
                        </select>
                    </fieldset>
                    <div class="error"><?php echo $aErroresDiccionario['word'] ?></div>
                    <fieldset>
                        <button name="buscarPalabra" value="buscarPalabra">Search</button>
                    </fieldset>
                </form>
                <div class="palabra">
            ...
            <div class="conversor">
                ...
                <form method="post">
                    <fieldset>                      
                        ...
                        <table>
                            <tr>
                                <th><label for="divisaOrigen">Currency</label><sup><a href="https://es.wikipedia.org/wiki/ISO_4217" target="_blank"><abbr title="Lista de códigos de divisas">ⓘ</abbr></a></sup></th>
                                <th><label for="cantidad">Quantity</label></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th><label for="divisaResultado">Convert to</label></th>
                                <th><label for="resultado">Result</label></th>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <fieldset class="submit">
                        <button name="convertir" value="convertir">Convert</button>
                    </fieldset>
                </form>
            </div>
        </section>
        <section id="buscarDPTOpropio">
            <div class="REST">
                ...
                <form method="post">
                    ...
                    <fieldset class="submit">
                        <button name="buscarDepartamento" value="buscarDepartamento">Search</button>
                    </fieldset>
                </form>
